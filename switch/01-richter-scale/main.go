...
func main() {
	...
	switch i, err := strconv.ParseFloat(os.Args[1], 64); {
	case err != nil:
		fmt.Println("I couldn't get that, sorry.")
	case i < 2.0:
		fmt.Println(i, "is micro")
	case i < 3.0:
		fmt.Println(i, "is very minot")
	case i < 4.0:
		fmt.Println(i, "is minor")
	case i < 5.0:
		fmt.Println(i, "is light")
	case i < 6.0:
		fmt.Println(i, "is moderate")
	case i < 7.0:
		fmt.Println(i, "is strong")
	case i < 8.0:
		fmt.Println(i, "is major")
	case i < 10.0:
		fmt.Println(i, "is great")
	default:
		fmt.Println(i, "is massive")
	}
}
